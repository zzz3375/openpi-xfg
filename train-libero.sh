...
XLA_PYTHON_CLIENT_MEM_FRACTION=0.9 WANDB_MODE=offline uv run scripts/train.py pi0_libero_low_mem_finetune --exp-name=pi0_libero_low_mem_finetune --overwrite